...
#' @param mask_genes A character vector. Genes in this vector will be masked from the analyses. It is probably a good idea to mask all HLA genes from the analysis.
...
#' @export
run_sclineager<-function(file_in,folder,categories,max_iter,mask_genes,vaf_offset,
